...
----------------------------------------------------------------------------------------------------------------------------------------
        ...
        FROM
                ...
                FROM
                            months, dssg_staging.entities_address_table_rs as a
        ...
        ;
        DROP TABLE IF exists dssg_staging.staging_train_monthly_split_{date_start_string}_{date_end_string}; --dssg_staging.staging_train_monthly_split_2015_06_01_2016_01_01; -- Need to change to                
        CREATE TABLE   --dssg_staging.staging_train_monthly_split_2015_06_01_2016_01_01
                       dssg_staging.staging_train_monthly_split_{date_start_string}_{date_end_string} 
        AS
        SELECT        *
        ...
        LEFT JOIN     dssg_staging.entities_address_table_rs a
        USING         (address_id)
